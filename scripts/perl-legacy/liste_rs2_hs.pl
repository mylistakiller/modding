# !/usr/bin/perl -w
# Programme Perl listant les fichiers rs2 des unités HS
# Date : 14 05 2014
# Author: Jean-Valère Cossu
# email: jvcossu@gmail.com
# Usage : perl liste_rs2_hs.pl
# use strict;
# use warning;
# Ouverture des fichiers 
print "Listing ... \n";
print "Liste les fichiers rs2 des unités situées dans le dossier UNITS-NAME-HS\n";
